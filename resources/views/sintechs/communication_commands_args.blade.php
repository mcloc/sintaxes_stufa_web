...
<li>Comunicação</li>
<li class="active">Argumentos de Comandos</li>
@endsection
...
@section('content')
<h3>Argumentos de Comandos</h3><br><br>
                ...
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">Listar Argumentos</div>
           ...
           <div class="card">
            <div class="card-body">
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">Adicionar Argumento</div>
                        </div>
                    </div>
                </div>
            </div>
