...
@section('content')
<h3>Comandos de Comunicação entre Módulos</h3><br><br>
                ...
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">Listar Comandos</div>
           ...
           <div class="card">
            <div class="card-body">
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">Adicionar Comando</div>
                        </div>
                    </div>
                </div>
            </div>
